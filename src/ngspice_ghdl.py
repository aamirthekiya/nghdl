...
class Mainwindow(QtGui.QWidget):
    ...
    def checkSupportFiles(self):
        ...
        if nonvhdl_count > 0:
            QtGui.QMessageBox.critical(
                ...
                <br/><br/>Supporting files should be <b>
                .vhdl</b> file ''')
    ...
    def createModelDirectory(self):
        ...
        if os.path.isdir(self.modelname):
            ...
            ret = QtGui.QMessageBox.warning(
                        ...
                        "overwrite it?</b><br/>If yes press ok, else cancel " +
                        "it and change the name of your vhdl file",
    ...
    def createModelFiles(self):
        ...
        shutil.copy(os.path.join(
            self.home, self.src_home) +
            "/src/ghdlserver/compile.sh",
            path + "/DUTghdl/")
        shutil.copy(os.path.join(
            self.home, self.src_home) +
            "/src/ghdlserver/uthash.h",
            path + "/DUTghdl/")
        shutil.copy(os.path.join(
            self.home, self.src_home) +
    ...
    def createSchematicLib(self):
        if Appconfig.esimFlag == 1:
            if not self.errorFlag:
                ...
                QtGui.QMessageBox.critical(
                    self, 'Error', '''Cannot create Schematic Library of your model.''' +
                     '''Resolve the <b>errors</b> shown on console of NGHDL window. ''')
        else:
        ...
        try:
            ...
            if self.file_extension == ".vhdl":
                ...
                QtGui.QMessageBox.information(
                    ...
                    This accepts only <b>.vhdl</b> file ''')
